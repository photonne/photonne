...
fun AlbumFormDialog(
    ...
    // Foco inicial en el nombre: la hoja existe para escribirlo.
...
fun DeleteAlbumDialog(
    ...
    ConfirmActionDialog(
        title = stringResource(Res.string.album_delete_title),
        message = stringResource(Res.string.album_delete_message, albumName),
