...
public class ObjectRecognitionClient : IObjectRecognitionClient
{
    private readonly HttpClient _http;
    private readonly MlOptions _options;
    private readonly ILogger<ObjectRecognitionClient> _logger;

    public ObjectRecognitionClient(HttpClient http, IOptions<MlOptions> options, ILogger<ObjectRecognitionClient> logger)
    {
        _http = http;
